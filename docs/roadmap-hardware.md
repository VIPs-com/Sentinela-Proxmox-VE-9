...
Este documento **não** obriga a compras nem a fases rígidas: descreve a **evolução pensada** do laboratório, do projeto anterior *Linux Foundation Lab* para o caminho atual **Fortaleza Proxmox**.
...
Isso é **horizonte** de aprendizagem (Proxmox cluster, storage avançado), não requisito do guia v5.0.
