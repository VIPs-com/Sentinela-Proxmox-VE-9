...
| **Meta — Validação linha-a-linha** | [validacao-linha-a-linha.md](validacao-linha-a-linha.md) | Registo **por partes** da releitura do guia (Parte 1 concluída; Partes 2–7 pendentes). |
