...
| **Meta — Validação linha-a-linha** | [validacao-linha-a-linha.md](validacao-linha-a-linha.md) | Registo **por partes** da releitura do guia (Partes 1–4 concluídas; Partes 5–7 pendentes). |
